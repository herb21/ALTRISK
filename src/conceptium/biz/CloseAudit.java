 ...
 * @author MathomeTD
 */
public class CloseAudit extends javax.swing.JFrame {

    /**
     * Creates new form StatusUpdate
     */
    private static CloseAudit obj = null;
    private CloseAudit() {;
        setResizable(false);
        setUndecorated(true);
        initComponents();
...
public static CloseAudit getObj(){
            if (obj == null){
                obj = new CloseAudit();
            }
            return obj;
   ...
   private void reference(){
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Audit", "Inspection" }));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        InternalAudits corrective = InternalAudits.getObj();
        if(statusCompleted.isSelected()){
            ...
            //corrective.cboHierachy.setSelectedItem(hierachy);
            //corrective.jDateChooser1.setDate(dueDate);
            //corrective.txtStatus.setText(choice);
            corrective.Closed.setSelected(true);
            corrective.Open.setEnabled(false);
            corrective.Pending.setEnabled(false);
            corrective.btnClose.setEnabled(false);
            corrective.btnSave.setEnabled(false);
            corrective.setVisible(true);
            this.dispose();
        }
        else{
            corrective.Pending.setSelected(true);
            corrective.Open.setEnabled(false);
            corrective.Closed.setEnabled(false);
            corrective.btnClose.setEnabled(false);
            corrective.btnSave.setEnabled(false);
            corrective.setVisible(true);
            this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CloseAudit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CloseAudit().setVisible(true);
            }
        });
    }
