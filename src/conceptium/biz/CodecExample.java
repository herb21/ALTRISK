...
public class CodecExample extends JPanel
{
	...
	public CodecExample(JFrame frame) throws IOException
	{
		super(new BorderLayout());

		// Listen when the frame is closed. The workspace should be saved.
		frame.addWindowListener((WindowListener) new WorkspaceSaver());
...
//				visualizersMap.put("minimizer", minimizer);
	...
	private class DockableMenuItem extends JCheckBoxMenuItem
	{
		...
		public DockableMenuItem(Dockable dockable)
		{
			...
			dockable.addDockingListener((DockingListener) dockableMediator);
			addItemListener((ItemListener) dockableMediator);
		}
        ...
        Runnable doCreateAndShowGUI = new Runnable() 
        {
            public void run() 
            {
                try {
                    ...
                    Logger.getLogger(CodecExample.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        };
